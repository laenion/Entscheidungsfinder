...
public class LocalizationSupport {
	...
	/**
	 Full path to the messages resource bundle. Feel free to change it if
	 you don't
	 use the message bundle file generated by IDE.
	 */
	private static final String _MESSAGES_BUNDLE = "/localization.properties";
	...
	/**
	 ...
	 parameter sign - '{0}', which is used to fill in a reason of the
	 failure.
	 */
	...
	/**
	 ...
	 (obtained
	 from "microedition.locale" system property). The initialization method
	 is called
	 automatically when a call to {@link #getMessage(java.lang.String)}
	 method is attempted for the first time.
	 You can call this method explicitly to see whether there was any
	 problem
	 with initialization of the localization support. Method returns a
	 status
	 of the successfulness. If there was any problem with initialization,
	 you can
	 get reason by using {@link #getErrorMessage()} method.

	 @return true if the intialization was succesfull, false if there was
	         any problem.
	 */
	...
	/**
	 ...
	 usually
	 called when a particular locale used in the application. E.g. the
	 application
	 contains only french messages (no default messages, only
	 <CODE>messages_fr.properties</CODE>
	 files is available), you should initialize the localization support (by
	 calling
	 <CODE>initLocalizationSupport("fr");</CODE>) before using
	 {@link #getMessage(java.lang.String)} method for the first
	 time.
	...
	/**
	 ...
	 localized
	 text. The message also possibly explainins a reason of the failure. The
	 message
	 is taken from <CODE>_INIT_LOCALIZATION_ERROR_MSG</CODE>.

	 @return error message if there was any failure or null when everything
	         is OK.
	 */
	...
	/**
	 ...
	 @return the localized string. If key is not found, then
	         <CODE>_DEFAULT_STRING</CODE> string
	         is returned
	 */
	...
	/**
	 determines whether the line of the supplied string continues on the
	 next line
